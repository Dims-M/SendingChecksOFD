namespace SendingChecksOFD
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.работаСКассойАтолToolStripMenuItem,
            ...
            this.проверитьОбновлениеToolStripMenuItem.Size = new System.Drawing.Size(389, 26);
            ...
            this.написатьРазработчикуИлиВТехподтержкуToolStripMenuItem.Click += new System.EventHandler(this.НаписатьРазработчикуИлиВТехподтержкуToolStripMenuItem_Click);
            // 
            // notifyIcon1
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem работаСКассойАтолToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem поискИПодключениеToolStripMenuItem;
